...
Este projeto é um site simples feito com Python (Flask) que serve para vender um e-book de forma automática. A ideia é bem prática: a pessoa entra no site, clica para comprar, paga pelo Stripe e, depois disso, recebe o e-book direto no e-mail sem você precisar fazer nada manualmente.
